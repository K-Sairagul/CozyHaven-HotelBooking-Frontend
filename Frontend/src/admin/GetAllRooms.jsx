    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        ...
        <Link
          ...
          className="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded transition duration-200 w-full sm:w-auto text-center"
        >
          Add New Room
        </Link>
      </div>
          ...
          >
            ...
            <div className="p-6 flex flex-col flex-1">
              ...
              <p className="text-gray-600 mb-2">
                ...
                {hotelNames[room.hotelId] || 'Hotel not found'}
              </p>
              ...
              <div className="flex flex-col md:flex-row gap-2 mt-auto">
                <Link
                  ...
                  className="w-full md:flex-1 text-center bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded transition duration-200"
                >
                  View
                </Link>
                <button
                  onClick={() => navigate(`/room/update/${room.roomId}`)}
                  className="w-full md:flex-1 bg-yellow-500 hover:bg-yellow-600 text-white font-medium py-2 px-4 rounded transition duration-200"
                >
                  Edit
                </button>
                <button
                  onClick={() => handleDelete(room.roomId)}
                  className="w-full md:flex-1 bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded transition duration-200"
                >
                  Delete
                </button>
              </div>
